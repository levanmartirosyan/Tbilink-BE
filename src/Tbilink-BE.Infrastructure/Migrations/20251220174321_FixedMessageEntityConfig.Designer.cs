...
namespace Tbilink_BE.Infrastructure.Migrations
{
    ...
    [Migration("20251220174321_FixedMessageEntityConfig")]
    partial class FixedMessageEntityConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tbilink_BE.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tbilink_BE.Domain.Entities.UserBan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tbilink_BE.Domain.Entities.Notification", b =>
                {
                    b.HasOne("Tbilink_BE.Models.User", "Actor")
                        .WithMany()
            ...
            modelBuilder.Entity("Tbilink_BE.Domain.Entities.UserBan", b =>
                {
                    b.HasOne("Tbilink_BE.Models.User", "BannedBy")
                        .WithMany()
